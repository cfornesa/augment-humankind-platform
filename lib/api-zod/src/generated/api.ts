...
export const createPostResponseTitleMax = 500;
...
export const CreatePostResponse = zod.object({
  ...
  "authorName": zod.string(),
  "authorImageUrl": zod.string().nullish(),
  "title": zod.string().max(createPostResponseTitleMax).nullish().describe('Optional post title. Null for title-less microblog posts.'),
  "content": zod.string(),
  "contentFormat": zod.enum(['plain', 'html']),
  "commentCount": zod.number(),
  "sourceFeedId": zod.number().nullish().describe('ID of the feed_sources row that imported this post (PESOS); null for owner-authored posts.'),
...
export const CreateArtPieceResponse = zod.object({
  "id": zod.number(),
  "ownerUserId": zod.string(),
  "title": zod.string(),
  "prompt": zod.string(),
...
export const DeleteArtPieceResponse = zod.void()
...
export const CreateArtPieceVersionResponse = zod.object({
  "piece": zod.object({
  "id": zod.number(),
  "ownerUserId": zod.string(),
  "title": zod.string(),
...
export const createFeedSourceResponseAuthorNameMax = 255;

export const createFeedSourceResponseImageUrlMax = 2048;



export const CreateFeedSourceResponse = zod.object({
  "id": zod.number(),
  "name": zod.string(),
  "username": zod.string().nullish().describe('Optional URL-safe handle for the feed\'s profile page (enables \/users\/@handle).'),
  "bio": zod.string().nullish().describe('Optional short description shown on the feed\'s profile page.'),
  "authorName": zod.string().max(createFeedSourceResponseAuthorNameMax).nullish().describe('Optional display name to use for all posts imported from this source. Falls back to the feed item\'s author, then the source name.'),
  "imageUrl": zod.string().max(createFeedSourceResponseImageUrlMax).nullish().describe('Optional profile photo URL for this feed source.'),
  "feedUrl": zod.string(),
  "siteUrl": zod.string().nullish(),
  "cadence": zod.enum(['daily', 'weekly', 'monthly']),
  "enabled": zod.boolean(),
...
export const DeleteFeedSourceResponse = zod.void()
...
export const uploadFeedSourceProfilePhotoResponseAuthorNameMax = 255;

export const uploadFeedSourceProfilePhotoResponseImageUrlMax = 2048;



export const UploadFeedSourceProfilePhotoResponse = zod.object({
  "id": zod.number(),
  "name": zod.string(),
  "username": zod.string().nullish().describe('Optional URL-safe handle for the feed\'s profile page (enables \/users\/@handle).'),
  "bio": zod.string().nullish().describe('Optional short description shown on the feed\'s profile page.'),
  "authorName": zod.string().max(uploadFeedSourceProfilePhotoResponseAuthorNameMax).nullish().describe('Optional display name to use for all posts imported from this source. Falls back to the feed item\'s author, then the source name.'),
  "imageUrl": zod.string().max(uploadFeedSourceProfilePhotoResponseImageUrlMax).nullish().describe('Optional profile photo URL for this feed source.'),
  "feedUrl": zod.string(),
  "siteUrl": zod.string().nullish(),
  "cadence": zod.enum(['daily', 'weekly', 'monthly']),
  "enabled": zod.boolean(),
...
export const createNavLinkResponseLabelMax = 64;

export const createNavLinkResponseUrlMax = 2048;



export const CreateNavLinkResponse = zod.object({
  "id": zod.number(),
  "label": zod.string().max(createNavLinkResponseLabelMax),
  "url": zod.string().max(createNavLinkResponseUrlMax),
  "openInNewTab": zod.boolean(),
  "sortOrder": zod.number(),
  "kind": zod.enum(['external', 'page', 'system']),
  "pageId": zod.number().nullish(),
...
export const createPageResponseSlugMax = 96;

export const createPageResponseTitleMax = 255;



export const CreatePageResponse = zod.object({
  "id": zod.number(),
  "slug": zod.string().max(createPageResponseSlugMax),
  "title": zod.string().max(createPageResponseTitleMax),
  "content": zod.string(),
  "contentFormat": zod.enum(['html']),
  "status": zod.enum(['draft', 'published']),
  "showInNav": zod.boolean(),
...
export const DeletePlatformConnectionResponse = zod.void()
...
export const CreateExhibitResponse = zod.object({
  "id": zod.number(),
  "slug": zod.string(),
  "name": zod.string(),
  "description": zod.string().nullish(),
...
export const DeleteExhibitResponse = zod.void()
...
export const BulkPermanentDeleteResponse = zod.void()
...
export const RestoreTrashedPostResponse = zod.void()
...
export const RestoreTrashedPieceResponse = zod.void()
...
export const RestoreTrashedMediaResponse = zod.void()
...
export const PermanentDeleteTrashedPostResponse = zod.void()
...
export const PermanentDeleteTrashedPieceResponse = zod.void()
...
export const PermanentDeleteTrashedMediaResponse = zod.void()
...
export const RestoreTrashedExhibitResponse = zod.void()
...
export const PermanentDeleteTrashedExhibitResponse = zod.void()
...
export const RestoreTrashedPageResponse = zod.void()
...
export const PermanentDeleteTrashedPageResponse = zod.void()
...
export const RestoreTrashedCategoryResponse = zod.void()
...
export const PermanentDeleteTrashedCategoryResponse = zod.void()
